...
public class InventoryUI : MonoBehaviour
{
    ...
    Dictionary<InventoryItem, InventorySlot> itemToSlotMap = new Dictionary<InventoryItem, InventorySlot>();
    ...
    InventorySlot CreateSlot(Inventory inventory, InventoryItem item, int itemCount)
    {
